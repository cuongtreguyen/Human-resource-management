...
//   // Mock credentials with roles and routes
//   const mockCredentials = {
//     admin: { 
...
//       // Check mock credentials and get user info
//       const userCredential = Object.values(mockCredentials)?.find(
//         cred => cred?.email === formData?.email && cred?.password === formData?.password
//       );
