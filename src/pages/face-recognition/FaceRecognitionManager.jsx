  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-2xl shadow-lg mb-6">
        ...
        <p className="text-blue-100">Quản lý nhận diện khuôn mặt và chấm công (Manager Portal)</p>
      </div>
          ...
          {activeTab === 'recognize' && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  {!cameraActive ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-gray-900">
                      <div className="text-center">
                        <Eye className="h-16 w-16 text-purple-500 mx-auto mb-4 animate-pulse" />
                ...
                <div className="flex gap-3">
                  {!cameraActive ? (
                    <button
                      ...
                      disabled={isLoading}
                      className="flex-1 bg-purple-600 text-white px-4 py-3 rounded-xl hover:bg-purple-700 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center space-x-2 shadow-sm transition-all hover:shadow-md"
                    >
              ...
              <div className="space-y-4">
                ...
                <div className="bg-purple-50 p-6 rounded-xl border border-purple-100 h-80 overflow-y-auto">
                  <div className="text-center py-8">
                    <p className="text-purple-800 font-medium mb-2">Hệ thống đang chờ dữ liệu...</p>
          ...
          {activeTab === 'employees' && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium">Tổng: 3 nhân viên</span>
              </div>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {[
                      ...
                      <tr key={emp.id} className="hover:bg-gray-50 transition-colors">
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-purple-900">{emp.id}</td>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-purple-900">EMP001</td>
                    ...
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-purple-900">EMP002</td>
