...
const EmployeeAttendance = () => {
  ...
  const handleRecognition = useCallback(
    async (type) => {
      ...
      try {
        // Face recognition removed - using Java backend attendance API instead
        const response = { status: 'error', message: 'Face recognition feature has been removed. Please use manual attendance.' };
