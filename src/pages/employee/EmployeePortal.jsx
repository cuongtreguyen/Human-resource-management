...
const EmployeePortal = () => {
  ...
  return (
    <EmployeeLayout>
      <div className="p-0">
        {/* Hero */}
        <div className="bg-gradient-to-r from-purple-600 to-purple-700 text-white p-8 rounded-2xl mb-8 shadow-lg hover:shadow-xl transition-all duration-300">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {[
            { label: "Phòng ban", value: employee?.department, emoji: "🏢", color: "purple" },
            { label: "Chức danh", value: employee?.position, emoji: "🧑‍💼", color: "blue" },
            { label: "Lương cơ bản", value: employee ? `${employee.salary?.toLocaleString()}₫` : "-", emoji: "💰", color: "green" },
          ].map((item) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
            ...
            <Card title="Tổng quan nhiệm vụ">
              {taskSummary ? (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="p-4 bg-green-50 rounded-lg hover:shadow-md transition-all">
                    <p className="text-gray-600 text-sm">Hoàn thành</p>
                    <p className="text-2xl font-bold text-green-700">{taskSummary.completedTasks}</p>
                  </div>
                  <div className="p-4 bg-blue-50 rounded-lg hover:shadow-md transition-all">
                    <p className="text-gray-600 text-sm">Đang làm</p>
                    <p className="text-2xl font-bold text-blue-700">{taskSummary.inProgressTasks}</p>
                  </div>
                  <div className="p-4 bg-red-50 rounded-lg hover:shadow-md transition-all">
                    <p className="text-gray-600 text-sm">Quá hạn</p>
          ...
          <div className="space-y-6">
            <Card title="Thông tin cá nhân">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-purple-600 to-purple-700 text-white flex items-center justify-center text-xl font-bold shadow-md">
