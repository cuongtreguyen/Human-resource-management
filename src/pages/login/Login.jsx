      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-900 via-blue-800 to-purple-900">
        ...
        <div className="absolute top-8 left-8 right-8 h-64 opacity-60">
          <div className="h-full bg-gradient-to-r from-blue-900/20 to-blue-800/20 rounded-lg border border-blue-400/30 backdrop-blur-sm">
            ...
            {/* Data Numbers */}
            <div className="absolute top-2 left-2 text-blue-300 text-xs font-mono animate-pulse">
              485
            </div>
            <div className="absolute top-2 right-2 text-blue-300 text-xs font-mono animate-pulse">
              0DF.025
            </div>
            <div className="absolute bottom-2 left-2 text-blue-300 text-xs font-mono animate-pulse">
              GDP 2024
            </div>
          </div>
          {/* Network Globe */}
        ...
        <div
          className="absolute top-3/4 right-16 w-8 h-8 bg-purple-300 opacity-30 rotate-45 animate-bounce"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-1/4 right-1/4 w-4 h-4 bg-cyan-300 opacity-50 rotate-45 animate-bounce"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/3 left-1/4 w-2 h-2 bg-white opacity-30 animate-bounce"
          style={{ animationDelay: "3s" }}
        ></div>
        <div
          className="absolute top-2/3 right-1/4 w-3 h-3 bg-blue-400 opacity-25 animate-bounce"
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm">
                    <a
                      href="#"
                      className="font-medium text-blue-600 hover:text-blue-500 underline glow-link"
                    >
      ...
      <div className="hidden lg:flex lg:absolute lg:right-0 lg:top-0 lg:w-1/2 lg:h-full lg:flex-col lg:justify-center lg:items-center lg:text-center lg:px-8 z-10">
        ...
        <div className="relative mb-8">
          <div className="w-32 h-32 bg-white rounded-full flex items-center justify-center shadow-2xl animate-pulse glow-intense">
            ...
            <div
              className="absolute inset-2 w-28 h-28 bg-purple-400 rounded-full opacity-60 animate-ping"
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div
            className="absolute top-1/4 right-8 w-6 h-6 bg-white opacity-30 rounded-full animate-bounce"
            style={{ animationDelay: "0.5s" }}
          ></div>
          <div
            className="absolute bottom-1/3 left-12 w-4 h-4 bg-blue-300 opacity-40 rounded-full animate-bounce"
            style={{ animationDelay: "1.5s" }}
          ></div>
          <div
            className="absolute top-1/2 right-16 w-8 h-8 bg-purple-300 opacity-25 rounded-full animate-bounce"
            style={{ animationDelay: "2.5s" }}
          ></div>
          <div
            className="absolute bottom-20 right-8 w-6 h-6 bg-cyan-300 opacity-35 rounded-full animate-bounce"
            style={{ animationDelay: "1s" }}
          ></div>
        </div>
      </div>
